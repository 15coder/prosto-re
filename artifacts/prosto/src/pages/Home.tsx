    ...
    <div className="bg-background text-foreground min-h-[100dvh] overflow-x-hidden selection:bg-primary selection:text-black font-sans">
      ...
      <footer className="bg-background pt-20 pb-10 border-t border-white/5">
        <div className="container px-6 mx-auto">
          ...
          {/* Bottom bar */}
          <div className="border-t border-white/8 pt-6 mt-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-white/20 text-[11px]">
              &copy; {new Date().getFullYear()} PROSTO Restaurant. All rights reserved.
            </p>

            {/* Developer chip — flat & compact */}
            <a
              href="https://Needaa.netlify.app"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 px-3 py-1.5 rounded-md transition-colors duration-200"
            ...
            >
              ...
              <span className="text-white/35 text-[11px]">تصميم وبرمجة</span>
              <span className="w-px h-3 bg-white/10" />
              <span className="text-white/65 text-[11px] font-medium group-hover:text-primary transition-colors duration-200">
                نداء الرحمن
              </span>
              <ExternalLink className="w-2.5 h-2.5 text-white/20 group-hover:text-primary/60 transition-colors duration-200 shrink-0" />
            </a>
          </div>
        </div>
      </footer>
